...
def addToContext():
    ...
    key_path = r'Directory\\Background\\shell\\GeoStamp\\' # Change 'Organiser' to the name of your project

    # Create outer key
    key = reg.CreateKey(reg.HKEY_CLASSES_ROOT, key_path)
    reg.SetValue(key, '', reg.REG_SZ, '&geostamp')  # Change 'Organise folder' to the function of your script
